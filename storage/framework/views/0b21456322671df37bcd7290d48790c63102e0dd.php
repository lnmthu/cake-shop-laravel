...
<head>
	...
	<?php echo $__env->yieldContent("meta_seo"); ?>
...
<body>
	...
	<?php echo $__env->make("front.layout.copyright", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    success:function(data)
                    {
                    	if(data==1)
                    	{
                    		swal({
								...
								function() {
	                                window.location.href = "<?php echo e(url('/shoppingCart')); ?>";
	                            });
                    	}else{
	                    	swal({
...
<?php /**PATH /Applications/MAMP/htdocs/LaravelSell/resources/views/front/layout/index.blade.php ENDPATH**/ ?>